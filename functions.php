...
class Unit {
    ...
    public static function init (array $args = NULL) : void {
    ...
    public static function register_metabox (WP_Post $post) : void {
	...
	public static function register_scripts () {
        ...
        if ($post !== NULL) {
	        ...
	        \wp_localize_script ('ym.app', 'ym', ['ajax_url'   => \admin_url( 'admin-ajax.php' ), 'unit' => $post]);
    ...
    public static function unit_with_meta () {
